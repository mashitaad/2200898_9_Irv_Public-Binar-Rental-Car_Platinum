              ...
              <div className="p-3 py-5">
                ...
                <div className="row mt-3">
                  ...
                  <div className="col-md-12">
                    ...
                    <p>{moment(orderDetail.start_rent_at).format('DD MMMM YYYY')}</p>
                  </div>
                  <div className="col-md-12">
                    <label className="labels">
                      <strong>Tanggal Berakhir</strong>
                    </label>
                    <p>{moment(orderDetail.finish_rent_at).format('DD MMMM YYYY')}</p>
                  </div>
                  <div className="col-md-12">
                    <label className="labels">
                      <strong>Total Bayar</strong>
                    </label>
                    <p>{formatter.format(orderDetail.total_price)}</p>
                  </div>
                </div>
                ...
                <div className="mt-5 text-center order-detail-button">
                  ...
                  {!orderDetail.status && orderDetail.slip && (
                    <>
                      <Button variant="success" onClick={navigateBack}>
                        Kembali
                      </Button>
                    </>
                  )}
