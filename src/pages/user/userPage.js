...
import SideBarAdmin from '../order-status/components/SIdeBarPayment'
                        ...
                        <div className="col-md-5 border-right">
                            <div className="p-3 py-5">
                                ...
                                <div className="row mt-2">
                                    ...
                                    <div className="col-md-6"><label className="labels">Name</label><p>irvan</p></div>
                                    <div className="col-md-6"><label className="labels">Surname</label><p>taufik</p></div>
                                </div>
                                <div className="row mt-3">
                                    <div className="col-md-12"><label className="labels">Mobile Number</label><p>08231123</p></div>
