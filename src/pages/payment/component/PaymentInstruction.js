        ...
        <Tabs activeKey={tabKey} onSelect={(e) => initTabKey(e)}>
          ...
          <Tab eventKey="mbca" title="M-BCA">
            <div className="payment-detail ">
              <ul>
                ...
                <li>
                  Periksa kembalian rincian pembayaran kamu, lalu klik “Ya“
                </li>
          ...
          <Tab eventKey="bcaklik" title="BCA Klik">
            <div className="payment-detail ">
              <ul>
                ...
                <li>
                  Pilih “Transfer Dana“, kemudian pilih “Transfer ke BCA Virtual
                  Account“.
                </li>
                <li>
                  Layar ATM akan menampilkan konfirmasi, ikuti instruksi untuk
                ...
                <li>
                  Pastikan data yang dimasukkan sudah benar, dan Input “Respon
                  KeyBCA“, lalu klik “Kirim“.
                </li>
              </ul>
            </div>
          </Tab>
          <Tab eventKey="internetbanking" title="Internet Banking">
            <div className="payment-detail ">
              <ul>
                <li>
                  Klik Internet Banking pada kolom Pilih Metode Pembayaran di
                  laman Pembayaran, lalu pilih “Klik BCA“.
                </li>
                <li>
                  Setelah klik “Bayar Sekarang“, kamu akan diarahkan ke laman
                  Klik BCA. Silakan login menggunakan User ID dan PIN KlikBCA
                  kamu.
                </li>
                <li>
                  Pilih Pembayaran e-Commerce pada menu utama Klik BCA. Pilih
                  Market Place pada pilihan Kategori dan BLIBLI.COM pada pilihan
                  Nama Perusahaan
                </li>
                <li>Pilih nomor rekening BCA kamu, lalu klik “Lanjutkan“.</li>
                <li>
                  Beri tanda centang pada transaksi yang ingin kamu bayar, lalu
                  klik “Lanjutkan”
                </li>
