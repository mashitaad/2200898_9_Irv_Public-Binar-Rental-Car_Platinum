        ...
        <div className="col-md-5 d-flex mt-5 detail-car-card">
          <div className="card-car">
            <div className="image-car-detail">
              {props.car?.image ? (
                <ImageWithLoading src={props.car?.image} alt={props.data?.name} />
              ) : (
                <ImageWithLoading src={nullImage} alt={'null image'} />
              )}
              ...
              <div className="row align-items-start">
                ...
                <div className="col pricedetail">{formatter.format(props.car?.price)}</div>
              </div>
              {/* Calendar section */}
              {props.message && (
              ...
              <div className="calendar-section">{props.children}</div>
            </div>
          </div>
        </div>
      </div>
